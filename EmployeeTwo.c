...
PtrToEmployee searchEmployeeByPhone(PtrToConstEmployee ptr, int size, char *phonetofind) {
    return searchEmployeeTable(ptr, size, phonetofind, compareEmployeePhone); //Want to compare by phone number
}
